...
!-----------------------------------------------------------------------
   jpiglo      =     130               !  number of columns of model grid
   jpjglo      =     130               !  number of rows of model grid
   ...
   nitend      =     500               !43200               !  end time step
   irecord     =     500               ! 180               !  intervals to save results
